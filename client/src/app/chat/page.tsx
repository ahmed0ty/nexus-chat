...
// import { LogOut, MessageCircle, Loader2, Settings } from "lucide-react";
...
//                     deleteMessage({ messageId: id, deleteForEveryone: forEveryone })
//                   }
...
//         initial={{ x: -300 }}
//         animate={{ x: 0 }}
//         className="w-80 flex-shrink-0 bg-gray-800 border-r border-gray-700 flex flex-col"
//       >
...
//               className="w-8 h-8 flex items-center justify-center text-gray-400 hover:text-red-400 hover:bg-gray-700 rounded-full transition-colors"
//             >
